...
def validate_cfm_full(model_warp, model_sofa, warp_val_data_raw, sofa_val_data_raw,
                      ...
                      sofa_mean, sofa_std,
                      num_points=7,
                      cfm_model_path="dataset_model/cfm_model_tensile_sim2real_gen.pth"):
    ...
    with torch.no_grad():
        ...
        try:
            ...
            fig_velocity.savefig("figures/cfm_vector_field_gen.png", dpi=300, bbox_inches="tight", pad_inches=0.01)
            fig_velocity.savefig("figures/cfm_vector_field_gen.pdf", bbox_inches="tight", pad_inches=0.01)
        ...
        fig_traj.savefig("figures/flow_trajectories_gen.png", dpi=300, bbox_inches="tight", pad_inches=0.01)
        fig_traj.savefig("figures/flow_trajectories_gen.pdf", bbox_inches="tight", pad_inches=0.01)
        plt.close(fig_traj)
        ...
        print(f"Force MSE: {force_mse:.4f}, MAE: {force_mae:.4f}")
    ...
    ax.plot(time_raw_np, force_true_raw_np, '-', linewidth=1.5, alpha=0.8, label="Exp True Force", color='tab:blue')
    ax.plot(time_raw_np, force_pred_raw_np, '--', linewidth=1.5, alpha=0.8, label="Exp Pred Force", color='tab:orange')
    ax.plot(time_raw_np, force_warp_raw_np, ':', linewidth=1.5, alpha=0.8, label="Sim Force", color='tab:green')
    ...
    fig.tight_layout()
    fig.savefig("cfm_force_vs_disp_gen_sim2real1.png", dpi=300, bbox_inches="tight", pad_inches=0.01)
    fig.savefig("cfm_force_vs_disp_gen_sim2real1.pdf",  bbox_inches="tight", pad_inches=0.01)
    ...
    fig.tight_layout()
    fig.savefig("cfm_point_trajectories_gen.png", dpi=300, bbox_inches="tight", pad_inches=0.01) 
    fig.savefig("cfm_point_trajectories_gen.pdf",  bbox_inches="tight", pad_inches=0.01)    
    ...
    plt.tight_layout()
    fig.savefig("cfm_individual_point_trajectories_gen.png", dpi=300, bbox_inches='tight')
    plt.close(fig)
...
def main():
    ...
    checkpoint_exp = torch.load("dataset_model_sim2real/predictor_exp_gen.pth")
    ...
    checkpoint_warp = torch.load("dataset_model_sim2real/predictor_sim_gen.pth")
    ...
    validate_cfm_full(predictor_warp, predictor_exp, warp_val_data_raw, exp_val_data_raw, warp_mean, warp_std, exp_mean, exp_std, num_points=num_points)
